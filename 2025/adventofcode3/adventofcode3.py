...
def joltage(data):
    return sum(int(max_batery_joltage(list(str(v)))) for v in data)

def max_batery_joltage(digits: list[str], nbateries: int = 12) -> str:
    ...
    return str(maxvalue) + max_batery_joltage(digits[index+1:], nbateries-1)
